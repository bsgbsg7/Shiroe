...
#define LV_FONT_DECLARE(font_name) extern const lv_font_t font_name;
    ...
    LV_FONT_DECLARE(lv_font_Chinese_siyuanheiti_10)
#endif

#if LV_FONT_CHINESE_SIYUANHEITI_24
    LV_FONT_DECLARE(lv_font_Chinese_siyuanheiti_24)
#endif

#if LV_FONT_CHINESE_SIYUANHEITI_12
    LV_FONT_DECLARE(lv_font_Chinese_siyuanheiti_12)
#endif

#if LV_CHINESE_FONT_10_ALL
    LV_FONT_DECLARE(lv_chinese_font_10_all)
#endif 

#if LV_CHINESE_FONT_12_ALL
    LV_FONT_DECLARE(lv_chinese_font_12_all)
#endif 

#if LV_CHINESE_FONT_16_ALL
    LV_FONT_DECLARE(lv_chinese_font_16_all)
#endif 

#if LV_CHINESE_FONT_24_ALL
    LV_FONT_DECLARE(lv_chinese_font_24_all)
#endif 

#if LV_CHINESE_FONT_32_ALL
    LV_FONT_DECLARE(lv_chinese_font_32_all)
#endif
