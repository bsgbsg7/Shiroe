...
{
    bilibili.update();
    // Serial.println(String(bilibili.fans));
    // Serial.println(String(bilibili.likes));
...
lv_obj_t *bilibili_config_load()
{
    ...
    //     // {
    //     main_color = lv_color_hex(0xeeeeee);
    //     // if (bilibili_theme == BILIBILI_PINK)
    //     //     text_color = lv_color_make(255, 83, 139);
    //     // else if (bilibili_theme == BILIBILI_BLUE)
    //         text_color = lv_color_make(28, 187, 255);
    //     // }
