...
lv_obj_t *setting_load()
{
    ...
    lv_obj_t *wifi_btn = lv_btn_create(now_screen);
    lv_obj_t *wifi_icon = lv_label_create(wifi_btn);
    lv_obj_t *wifiAP_btn = lv_btn_create(now_screen);
    lv_obj_t *wifiAP_icon = lv_label_create(wifiAP_btn);
    lv_obj_t *blue_btn = lv_btn_create(now_screen);
    lv_obj_t *blue_icon = lv_label_create(blue_btn);
    lv_obj_t *theme_btn = lv_btn_create(now_screen);
    lv_obj_t *theme_icon = lv_label_create(theme_btn);
    lv_obj_t *safe_btn = lv_btn_create(now_screen);
    lv_obj_t *safe_icon = lv_label_create(safe_btn);
    lv_obj_t *update_btn = lv_btn_create(now_screen);
    lv_obj_t *update_icon = lv_label_create(update_btn);
    lv_obj_t *about_btn = lv_btn_create(now_screen);
